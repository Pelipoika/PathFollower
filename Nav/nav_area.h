...
inline void CNavArea::GetClosestPointOnArea(const Vector* pPos, Vector* close) const
{
	float x, y, z;
...
//--------------------------------------------------------------------------------------------------------------
inline void CNavArea::ComputeNormal(Vector *normal, bool alternate) const
{
	if (!normal)
		return;
...
inline float CNavArea::GetZ( float x, float y ) const RESTRICT
{
 ...
 */
inline void CNavArea::ComputePortal( const CNavArea *to, NavDirType dir, Vector *center, float *halfWidth ) const
{
 ...
 */
inline bool CNavArea::IsConnected( const CNavArea *area, NavDirType dir ) const
{
 ...
 */
inline float CNavArea::ComputeAdjacentConnectionHeightChange( const CNavArea *destinationArea ) const
{
...
inline void CNavArea::GetExtent( Extent *extent ) const
{
...
//--------------------------------------------------------------------------------------------------------
inline Vector CNavArea::GetRandomPoint( void ) const
{
	Extent extent;
	GetExtent( &extent );
