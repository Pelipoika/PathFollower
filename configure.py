...
builder.options.add_option('--hl2sdk-root', type=str, dest='hl2sdk_root', default="C:\sdkfolder", help='Root search folder for HL2SDKs')
builder.options.add_option('--mms-path', type=str, dest='mms_path', default="C:\sdkfolder\mmsource-1.10", help='Path to Metamod:Source')
builder.options.add_option('--sm-path', type=str, dest='sm_path', default="C:\sdkfolder\sourcemod", help='Path to SourceMod')
